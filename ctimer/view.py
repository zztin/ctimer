...
class CtimerClockView(tk.Frame):
    def __init__(self, timer_model, master):
        ...
        self.create_widgets()
        self._label_total_clock_counts.config(text=f"Done: {self.tm.clock_details.clock_count}")
    ...
    def show_time(self, time_text, total_clock_counts):
        ...
        self._label_total_clock_counts.config(text=f"Total clocks: {total_clock_counts}")
    ...
    def get_goal(self):
        ...
        self._label_goal_show["text"] = f"Goal: {self.tm.clock_details.task_description}"
